    ...
    public runRaymarcher(
        ...
        for (let y = yStart; y < yEnd; y++) {
            ...
            for (let x = 0; x < width; x++) {
                ...
                // --- perform adaptive-step raymarch ---
                const depth = this.adaptiveStepMarch(scene, rayOrigin, rayDir, idx, SDFevaluationBuffer, iterationsBuffer);
